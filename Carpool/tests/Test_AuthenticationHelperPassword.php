...
class Test_AuthenticationHelperPassword extends PHPUnit_TestCase {
    ...
    function testFailedLogon() {
        ...
        $params1 = array('user' => 'user1@mail.com', 'password' => 'PASS1');
        $this->assertFalse($this->helper->authenticate($params1));
        
        // Empty password
        $params2 = array('user' => 'user1@mail.com', 'password' => '');
        $this->assertFalse($this->helper->authenticate($params2));
        
        // No such user
        $params3 = array('user' => 'nosuch@mail.com', 'password' => 'XXXX');
        $this->assertFalse($this->helper->authenticate($params3));
        
        // Empty user
        $params4 = array('user' => '', 'password' => 'XXXX');
    ...
    function testSuccessLogonNewUser() {
        ...
        // First let's fail
        $params1 = array('user' => 'user2@mail.com', 'password' => '---longpassword12---');
        $this->assertFalse($this->helper->authenticate($params1));
        
        // This should work
        $params2 = array('user' => 'user2@mail.com', 'password' => '---longpassword123---');
