...
INSERT INTO QuestionsAnswers (Id, Lang, Question, Answer) VALUES(2,2,'מדוע כדאי לי להצטרף?','כי זה ירוק יותר. כי זה עשוי לחסוך לך כסף על דלק וכבישי אגרה. כי זה הרבה יותר כיף.');
INSERT INTO QuestionsAnswers (Id, Lang, Question, Answer) VALUES(3,1,'How can I delete/modify my account?','Use the authentication link to authenticate yourself. Then, under "My Profile", you can edit your settings, delete or de-activate your account.');
INSERT INTO QuestionsAnswers (Id, Lang, Question, Answer) VALUES(3,2,'איך אפשר לערוך/לשנות את החשבון שלי?','השתמשו בקישור ההזדהות כי לזהות את עצמכם. לאחר מכן תוכלו לעדכן או למחוק את פרטיכם בדף "הפרופיל שלי".');
INSERT INTO QuestionsAnswers (Id, Lang, Question, Answer) VALUES(4,1,'What is the authentication link? Where can I find it?','The authentication link used to identify you, instead of username and password. You can find it in the mail you received right after the registration. To use it, just paste this link in your browser.');
